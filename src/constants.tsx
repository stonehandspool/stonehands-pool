...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-10-19T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'HOU @ SEA';
export const PREV_WEEK_FINAL_GAME: string = 'CHI @ WAS';
...
export const MONDAY_NIGHT_TOTAL: number = 46;
