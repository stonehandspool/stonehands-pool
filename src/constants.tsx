...
export const CURRENT_WEEK: number = 10;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-11-10T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'MIA @ LAR';
export const PREV_WEEK_FINAL_GAME: string = 'TB @ KC';
...
export const MONDAY_NIGHT_TOTAL: number = 38;
export const PREV_MONDAY_NIGHT_TOTAL: number = 54;
