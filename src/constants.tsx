...
export const CURRENT_WEEK: number = 3;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-09-21T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'DET @ BAL';
export const PREV_WEEK_FINAL_GAME: string = 'LAC @ LV';
...
export const MONDAY_NIGHT_TOTAL: number = 68;
export const PREV_MONDAY_NIGHT_TOTAL: number = 29;
