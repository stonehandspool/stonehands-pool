...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-12-21T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'SF @ IND';
export const PREV_WEEK_FINAL_GAME: string = 'MIA @ PIT';
...
export const MONDAY_NIGHT_TOTAL: number = 75;
