...
export const CURRENT_WEEK: number = 17;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-12-29T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'DET @ SF';
export const PREV_WEEK_FINAL_GAME: string = 'NO @ GB';
...
export const MONDAY_NIGHT_TOTAL: number = 74;
export const PREV_MONDAY_NIGHT_TOTAL: number = 34;
