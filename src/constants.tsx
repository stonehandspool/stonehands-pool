...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-09-14T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'LAC @ LV';
export const PREV_WEEK_FINAL_GAME: string = 'MIN @ CHI';
