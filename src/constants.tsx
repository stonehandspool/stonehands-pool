...
export const CURRENT_WEEK: number = 12;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-11-24T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'BAL @ LAC';
export const PREV_WEEK_FINAL_GAME: string = 'HOU @ DAL';
...
export const MONDAY_NIGHT_TOTAL: number = 53;
export const PREV_MONDAY_NIGHT_TOTAL: number = 44;
