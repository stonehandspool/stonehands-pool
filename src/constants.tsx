...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-11-17T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'HOU @ DAL';
export const PREV_WEEK_FINAL_GAME: string = 'MIA @ LAR';
...
export const PREV_MONDAY_NIGHT_TOTAL: number = 38;
