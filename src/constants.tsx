...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-10-26T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'WAS @ KC';
export const PREV_WEEK_FINAL_GAME: string = 'HOU @ SEA';
...
export const PREV_MONDAY_NIGHT_TOTAL: number = 46;
