...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-10-06T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'NO @ KC';
...
export const MONDAY_NIGHT_TOTAL: number = 39;
