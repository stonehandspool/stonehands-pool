...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-12-07T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'PHI @ LAC';
export const PREV_WEEK_FINAL_GAME: string = 'NYG @ NE';
...
export const MONDAY_NIGHT_TOTAL: number = 41;
export const PREV_MONDAY_NIGHT_TOTAL: number = 48;
