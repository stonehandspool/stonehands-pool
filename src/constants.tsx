...
export const CURRENT_WEEK: number = 9;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-11-02T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'AZ @ DAL';
export const PREV_WEEK_FINAL_GAME: string = 'WAS @ KC';
...
export const MONDAY_NIGHT_TOTAL: number = 44;
export const PREV_MONDAY_NIGHT_TOTAL: number = 35;
