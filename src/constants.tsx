...
export const CURRENT_WEEK: number = 14;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-12-08T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'CIN @ DAL';
export const PREV_WEEK_FINAL_GAME: string = 'CLE @ DEN';
...
export const MONDAY_NIGHT_TOTAL: number = 47;
export const PREV_MONDAY_NIGHT_TOTAL: number = 73;
