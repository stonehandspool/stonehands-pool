...
export const CURRENT_WEEK: number = 13;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-12-01T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'CLE & DEN';
export const PREV_WEEK_FINAL_GAME: string = 'BAL @ LAC';
...
export const MONDAY_NIGHT_TOTAL: number = 73;
export const PREV_MONDAY_NIGHT_TOTAL: number = 53;
