...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-09-22T17:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'WAS @ CIN';
...
export const MONDAY_NIGHT_TOTAL: number = 71;
