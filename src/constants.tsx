...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2024-12-15T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'ATL @ LV';
export const PREV_WEEK_FINAL_GAME: string = 'CIN @ DAL';
...
export const MONDAY_NIGHT_TOTAL: number = 24;
export const PREV_MONDAY_NIGHT_TOTAL: number = 47;
