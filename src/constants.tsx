...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-11-09T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'PHI @ GB';
export const PREV_WEEK_FINAL_GAME: string = 'AZ @ DAL';
