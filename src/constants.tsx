...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-11-30T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'NYG @ NE';
export const PREV_WEEK_FINAL_GAME: string = 'CAR @ SF';
...
export const MONDAY_NIGHT_TOTAL: number = 48;
