...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-01-05T18:00:00.000Z');
...
export const MONDAY_NIGHT_TOTAL: number = 40;
export const PREV_MONDAY_NIGHT_TOTAL: number = 74;
...
export const MARCH_MADNESS_CUTOFF = new Date('2025-03-20T17:00:00.000Z');
