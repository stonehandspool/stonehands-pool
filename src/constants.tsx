...
export const CURRENT_WEEK: number = 15;
...
export const CURRENT_WEEK_CUTOFF_TIME = new Date('2025-12-14T18:00:00.000Z');
...
export const CURRENT_WEEK_FINAL_GAME: string = 'MIA @ PIT';
export const PREV_WEEK_FINAL_GAME: string = 'PHI @ LAC';
...
export const MONDAY_NIGHT_TOTAL: number = 43;
export const PREV_MONDAY_NIGHT_TOTAL: number = 41;
