  ...
  return (
    <div className="container pb-6">
      ...
      <h4 className="subtitle">
        Pick a winner for every game and assign points based off how confident
        you are they will win! {numOptions} is the <b>most</b> confident while 1
        is the <b>least</b> confident. If you are right, you will get that many
        points in the confidence pool. <b>{numOptions} = best, 1 = worst!</b>
      </h4>
      <div className="columns is-multiline">
        {Object.keys(weekInfo).map((matchup, index) => {
          const priorChoice =
            Object.keys(priorPicks).length === 0 &&
            priorPicks.constructor === Object
              ? null
                ...
                <div className="columns is-centered is-multiline">
                  ...
                  <div className="column is-three-fifths">
                    <MatchupCard
                      ...
                      matchupNumber={index}
                      gameStarted={
                        currentTime > new Date(weekInfo[matchup].time)
                      }
