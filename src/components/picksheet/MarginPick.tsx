  ...
  return (
    <div className="container pb-6">
      ...
      <h4 className="subtitle">
        ...
        added to your margin pool score. If you are wrong, that teams losing margin is subtracted from your margin pool
        score. You can only choose each team <b>once</b> in the margin pool, so choose carefully! You cannot be
