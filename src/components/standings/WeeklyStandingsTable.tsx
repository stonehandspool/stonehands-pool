...
function WeeklyStandingsTable() {
  ...
  for (let i = 0; i < players.length; i++) {
    ...
    const rowInfo: TableColumns = {
      ...
      points:
        CURRENT_WEEK > 1
          ? playerInfo.pointsByWeek[weekToShow]
          : playerInfo.currentWeekPoints,
      wins:
        CURRENT_WEEK > 1
          ? playerInfo.winsByWeek[weekToShow]
          : playerInfo.currentWeekWins,
      losses:
        CURRENT_WEEK > 1
          ? playerInfo.lossesByWeek[weekToShow]
          : playerInfo.currentWeekLosses,
      ties:
        CURRENT_WEEK > 1
          ? playerInfo.tiesByWeek[weekToShow]
          : playerInfo.currentWeekTies,
      tiebreaker:
        CURRENT_WEEK > 1
          ? playerInfo.tiebreakerByWeek[weekToShow]
