...
function HighFiveTable() {
    ...
    playerPicks.sort((row1, row2) => {
        ...
        return row2.highFiveTotal - row1.highFiveTotal || row2.numGamesRight - row1.numGamesRight || lastName1.localeCompare(lastName2) || firstName1.localeCompare(firstName2);
    });
