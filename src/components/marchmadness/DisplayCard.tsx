...
function DisplayCard(props: DisplayCardProps) {
  ...
  if (actualWinner === null && topTeamAlive && bottomTeamAlive) {
    ...
    const actualWinnerName =
      actualWinner === "top" ? actualTopTeam.name : actualBottomTeam.name;
    const chosenWinnerName = winner === "top" ? topTeam.name : bottomTeam.name;
    if (winner === "top" && actualWinnerName === chosenWinnerName) {
      topTeamColor =
        actualWinner === "top" ? "has-text-success" : "has-text-danger";
      bottomTeamColor =
        actualBottomTeam.name === bottomTeam.name
          ? "has-text-black"
          : "has-text-danger";
    } else if (winner === "bottom" && actualWinnerName === chosenWinnerName) {
      topTeamColor =
        actualTopTeam.name === topTeam.name
          ? "has-text-black"
          : "has-text-danger";
      bottomTeamColor =
        actualWinner === "bottom" ? "has-text-success" : "has-text-danger";
  ...
  const topTeamWeight =
    winner === "top" ? "has-text-weight-bold" : "has-text-weight-normal";
  const bottomTeamWeight =
    winner === "bottom" ? "has-text-weight-bold" : "has-text-weight-normal";
