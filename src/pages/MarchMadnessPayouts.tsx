                    ...
                    <div className='column'>
                        ...
                        <table className='table mx-auto'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><b>6<sup>th</sup></b></td>
                                    <td>Nicole Tseng</td>
                                    <td>{toMoney(final6)} (6%)</td>
                                </tr>
                                <tr>
                                    <td><b>7<sup>th</sup></b></td>
                                ...
                                <tr>
                                    <td><b>13<sup>th</sup></b></td>
                                    <td>Alex Gugliada</td>
                                    <td>{toMoney(final13)} (1%)</td>
                                </tr>
                                <tr>
                                    <td><b>14<sup>th</sup></b></td>
                                    <td>Tom Hellen</td>
                                    <td>{toMoney(final14)} (1%)</td>
                                </tr>
                                <tr>
                                    <td><b>15<sup>th</sup></b></td>
                                    <td>Paige Seitz</td>
                        ...
                        <table className='table mx-auto'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><b>3<sup>rd</sup></b></td>
                                    <td>Jeff Fandl</td>
                                    <td>{toMoney(roundAmount)}<sup>1</sup></td>
                                </tr>
                                <tr>
                                    <td><b>4<sup>th</sup></b></td>
                                    <td>Alissa Onofrio</td>
                                    <td>{toMoney(roundAmount / 2)}<sup>2</sup></td>
                                </tr>
                                <tr>
                                    <td><b>4<sup>th</sup></b></td>
                                    <td>Bobby Crimmins</td>
                                ...
                                <tr>
                                    <td><b>5<sup>th</sup></b></td>
                                    <td>Mark Maltz</td>
                                    <td>{toMoney(roundAmount)}<sup>3</sup></td>
                                </tr>
                            </tbody>
                        </table>
                        <p>
                            <b><sup>1</sup></b>I technically won this round but I'm awarding the payout to Jeff Fandl
                            because I messed up the scoring and he was the original winner of this round
                        </p>
                        <p>
                            <b><sup>2</sup></b>Alissa and Bobby ties this round so the pot was split
                        </p>
                        <p>
                            <b><sup>3</sup></b>There was a 12-way tie for this round and so I picked a winner in the
                            only logical way I could think, an online duck race. You can do your own races <a href="https://www.online-stopwatch.com/duck-race/">here</a>
                        </p>
                    </div>
                    <div className='column'>
