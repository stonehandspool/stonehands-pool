...
import payouts from '../../data/2025/football/payouts.json';
                ...
                return (
                  ...
                  >
                    ...
                    <td key={`${info.id}-yearly`}>
                      {info.seasonPayouts[0] > 0 ? `$${info.seasonPayouts[0].toFixed(2)}` : '-'}
                    </td>
                    <td key={`${info.id}-survivor`}>
                      {info.survivorPayout > 0 ? `$${info.survivorPayout.toFixed(2)}` : '-'}
                    </td>
                    <td key={`${info.id}-margin`}>
                      {info.marginPayout > 0 ? `$${info.marginPayout.toFixed(2)}` : '-'}
                    </td>
                    <td key={`${info.id}-high-five`}>
                      {info.highFivePayout > 0 ? `$${info.highFivePayout.toFixed(2)}` : '-'}
                    </td>
