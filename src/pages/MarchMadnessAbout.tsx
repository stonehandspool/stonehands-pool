...
function MarchMadnessAbout() {
    ...
    const final6 = totalFinal * .06;
    const final7 = totalFinal * .05;
            ...
            <div className='container'>
                ...
                <div className='columns is-centered'>
                    <div className='column is-two-thirds'>
                        ...
                        <p className='mb-2'>
                            ...
                            payouts to the person who gains the most points each round. <b>All</b> money will be paid out at the end, I don't keep any of it.
                        </p>
                        <p className='mb-2'>
                            You are free to submit your picksheet any time prior to the start of the first game of the tournament but there is a hard cutoff at that time! No
                            picksheets will be accepted after the start of the first game, no exceptions! <b>You will also be able to modify your picks leading up to the start
                                of the tournament as many times as you'd like.</b>
                        </p>
                        <p className='mb-5'>
                            This Pool is intended to be played by any family and friends who are interested! Feel free to invite any and everyone to this Pool as well, the more the merrier!
                        </p>
                    </div>
                </div>
                ...
                <div className='columns is-centered mb-5'>
                    <div className='column is-two-thirds'>
                        <div className='content'>
                            <ul>
                                <li>Picksheets must be submitted prior to the start of the tournament, <b>no exceptions</b>!</li>
                ...
                <div className='columns is-centered'>
                    <div className='column is-two-thirds'>
                        <p className='mb-5'><b>Same as the Football Pools, the March Madness Pool will always pay out 100% of the collected buy ins. The site upkeep will be handled by Ryan.</b></p>
                        ...
                        <p className='has-text-danger'>In the payment description please use the format: 'March Madness Stonehands for: "name(s)"' </p>
                        <br />
                        <p>
                        ...
                        <p><b>Final Standings Pot: </b> {toMoney(totalFinal)}</p>
                        <p><b>Per Round Pot: </b> {toMoney(totalRounds)}</p>
                        <br />

                        <p><b>Payout Amounts:</b></p>
                        <div className='columns'>
                            <div className='column is-narrow'>
                                ...
                                <p><b>6<sup>th</sup>: </b>{toMoney(final6)} (6%)</p>
                                <p><b>7<sup>th</sup>: </b>{toMoney(final7)} (5%)</p>
                            ...
                            <div className='column is-narrow'>
                                ...
                                <br />
                                <p><b>1<sup>st</sup> Round: </b>{toMoney(roundAmount)}</p>
                                <p><b>2<sup>nd</sup> Round: </b>{toMoney(roundAmount)}</p>
                ...
                <div className='columns is-centered'>
                    <div className='column is-two-thirds'>
                        ...
                        <p className='mb-5'>
                            Winnings will be paid out at the end of the tournament, no exceptions.
                        </p>
                    </div>
                </div>
            </div>
