      ...
      <div className="container">
        ...
        <div className="columns is-centered">
          <div className="column is-two-thirds">
            ...
            <p className="mb-2">
              ...
              further down). There will also be 6 extra payouts to the person who gains the most points each round.{' '}
              <b>All</b> money will be paid out at the end, I don't keep any of it.
            </p>
            <p className="mb-2">
              You are free to submit your picksheet any time prior to the start of the first game of the tournament but
              there is a hard cutoff at that time! No picksheets will be accepted after the start of the first game, no
              exceptions!{' '}
              <b>
                You will also be able to modify your picks leading up to the start of the tournament as many times as
                you'd like.
              </b>
            </p>
            <p className="mb-5">
              This Pool is intended to be played by any family and friends who are interested! Feel free to invite any
        ...
        <div className="columns is-centered">
          <div className="column is-two-thirds">
            ...
            <p>
              As an example if you pick a 14 seed to go to the Final 4 and they do you will be awarded 14 points for
              their win in the Round of 64, an additional 28 points for their win in the Round of 32, 56 points for
              their win in the Sweet 16, and 112 points more for their win in the Elite 8. This is done to encourage
              more ambitious picks and to reward those who make those picks! The standings will be determined by whoever
              has the most cumulative points based off of the games they pick correctly.
            </p>
          </div>
        </div>
        ...
        <div className="columns is-centered mb-5">
          <div className="column is-two-thirds">
            <div className="content">
              <p>
                Here are the following tiebreakers for the pool for if/when two players have the same number of points:
              </p>
              <ol>
                <li>
                  The first tiebreaker will be given to the player who guessed the closest <b>total</b> score of the
                  final game
                </li>
                <ul>
                  <li>
                    You <b>can</b> guess over the total, this is not Price Is Right rules, someone 1 point above the
                    total would win the tiebreaker over someone who guessed 2 points under
                  </li>
                </ul>
                <li>The second tiebreaker will be the number of games guessed correctly</li>
                <li>
                  If somehow those two tiebreakers don't choose a winner, the payout will be split evenly between the
                  two players
                </li>
              </ol>
            </div>
        ...
        <div className="columns is-centered mb-5">
          <div className="column is-two-thirds">
            <div className="content">
              <ul>
                <li>
                  Picksheets must be submitted prior to the start of the tournament, <b>no exceptions</b>!
                </li>
                <li>You may not submit a partial picksheet to come back to later, you must fill it out completely</li>
                <li>Picksheets may be updated as many times as you'd like up until the start of the tournament</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="columns is-centered">
          <div className="column is-two-thirds">
            <p className="mb-5">
              <b>
                Same as the Football Pools, the March Madness Pool will always pay out 100% of the collected buy ins.
                The site upkeep will be handled by Ryan.
              </b>
            </p>
            ...
            <p className="has-text-danger">
              In the payment description please use the format: 'March Madness Stonehands for: "name(s)"'{' '}
            </p>
            <br />
            <p>
              Below is the <b>tentative</b> pay structure for the Pool, it will be finalized once all submissions are
        ...
        <div className="columns is-centered">
          <div className="column is-two-thirds">
            ...
            <p className="mb-5">
              <b>I ask that everyone pays prior to the start of the tournament.</b> If payments aren't received by the
              start of the <b>round of 64 (1st round)</b> then I will reach out to you. If payment is not received by
              the start of the <b>round of 32 (2nd round)</b>, then you will be disqualified (and put on double secret
              probation) from the pool.
            </p>
            <h5 className="title is-5">When will I receive my winnings?</h5>
            <p className="mb-5">Winnings will be paid out at the end of the tournament, no exceptions.</p>
          </div>
        </div>
      </div>
    </section>
