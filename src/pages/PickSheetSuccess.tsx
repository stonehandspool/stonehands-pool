            ...
            <div className='columns is-centered'>
                <div className='column is-three-quarters'>
                    ...
                    <table className='table is-bordered mx-auto'>
                        <thead>
                            <tr>
                                <th className='has-text-centered' colSpan={3}>Week {CURRENT_WEEK} picks for {`${userPicks.firstName} ${userPicks.lastName}`}</th>
                            </tr>
                            <tr>
                    ...
                    <table className='table is-bordered mx-auto'>
                        <thead>
                            <tr>
                                <th className='has-text-centered' colSpan={5}>High 5 Picks</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                {
                                    userPicks.highFivePicks.map((pick: string) => {
                                        const displayName = teams[pick as keyof typeof teams].displayName;
                                        return (
                                            <td className='has-text-centered' key={`high-5-${pick}`}>{displayName}</td>
                                        )
                                    })
                                }
                            </tr>
