...
const endOfYearPayouts = [327.60, 278.46, 229.32, 196.56, 163.80, 131.04, 90.09, 81.90, 73.71, 65.52];
const weeklyConfidencePayouts = [42.47, 36.10, 29.73, 25.48, 21.23, 16.99, 11.68, 10.62, 9.55, 8.49];
const marginHighFivePayouts = [296.40, 195, 117, 93.60, 78];
