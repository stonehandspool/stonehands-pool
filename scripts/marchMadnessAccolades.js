...
const ambitiousPeopleDataToExport = {
    ...
    description: 'These are the people who had the highest maximum points at the beginning of the tournament (most upsets picked)',
    data: [],
};
...
const bestBracketTitleDataToExport = {
    ...
    description: 'These were my favorite bracket titles that people submitted in no particular order. I don\'t know what they all mean, but they all gave me a good laugh. I just want it known that one of them is a lie.',
    data: [],
};
